...
if __name__ == '__main__':
    ...
    parser.add_argument('--bert_init', type=str, default='roberta-base',choices=["roberta-base","distilbert/distilbert-base-uncased-finetuned-sst-2-english", "bert-base-uncased", "microsoft/deberta-v3-base","deberta-v3-base","deberta-base"])

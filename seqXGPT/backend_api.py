...
MODEL_MAPPING_NAMES = OrderedDict([
    ...
    ("llama3.1", SnifferNewerLlamaModel),
...
def parse_args():
    ...
    parser.add_argument(
        ...
        default="llama3.1",
        help=
        "The model to use. You can choose one of [gpt2, gptneo, gptj, llama, llama3.1, wenzhong, skywork, damo, chatglm, alpaca, dolly].",
    )

...
def get_features(type, input_file, output_file):
    ...
    en_model_names = ['gpt_2', 'gpt_neo', 'gpt_J', 'llama', 'llama3.1']
    ...
    llama3_1_api = 'http://0.0.0.0:6007/inference'
    ...
    # Original SeqXGPT used all apis for en_models, AIDetectionPaper just used the gpt_2_api
    en_model_apis = [llama3_1_api]

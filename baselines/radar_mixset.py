...
def run_radar(data, DEVICE, finetune: bool = False, no_auc: bool = False, ckpt_dir='./ckpt', test_only: bool = False,
    ...
    model = AutoModelForSequenceClassification.from_pretrained("TrustSafeAI/RADAR-Vicuna-7B", config=config,
...
if __name__ == "__main__":
    ...
    logging.info(f"Radar score: {output}")
